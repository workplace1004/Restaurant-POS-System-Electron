...
const KEY_STYLE = 'w-[45px] h-[50px] bg-pos-panel rounded text-white text-2xl hover:bg-pos-panel/80 border border-transparent transition-colors';
      ...
      <div className="flex gap-4">
        <div className="flex flex-col gap-1">
          ...
          <div className="flex gap-1.5">
            ...
            <button type="button" className={`${KEY_STYLE} min-w-[96px]`} onClick={() => sendKey('Backspace')} aria-label="Backspace">
              ←
            </button>
          </div>
          <div className="flex gap-1.5">
            ...
            <button type="button" className="bg-pos-panel rounded hover:bg-pos-panel/80 w-[198px] h-[50px] border border-transparent transition-colors" onClick={() => sendKey(' ')} aria-label="Space" />
