  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="relative bg-pos-bg rounded-xl shadow-2xl max-w-[90%] w-full justify-center items-center mx-4 overflow-hidden flex flex-col max-h-[90vh]" onClick={(e) => e.stopPropagation()}>
        <button type="button" className="absolute top-2 right-4 z-10 p-2 rounded text-pos-muted hover:text-pos-text hover:bg-pos-panel" onClick={onClose} aria-label="Close">
        ...
        <div className="flex mt-6 mb-4 px-6 w-full justify-center shrink-0 gap-20">
          {[
            ...
            <button
              key={tabItem.id}
              type="button"
              className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors ${tab === tabItem.id ? 'border-blue-500 text-pos-text' : 'border-transparent text-pos-muted hover:text-pos-text'}`}
        ...
        <div className="p-6 overflow-hidden flex-1 flex flex-col py-2">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button type="button" className="p-2 px-3 rounded bg-pos-panel border border-pos-border text-pos-text hover:bg-pos-bg font-medium" onClick={() => setNumberOfPrints((n) => n + 1)}>+</button>
                  </div>
                </div>
              </div>
              <div className="flex flex-col gap-6">
          ...
          <div className="flex justify-center gap-4 text-md pt-5">
            ...
            <button type="button" className="flex items-center gap-4 px-6 py-3 rounded-lg bg-green-600 text-white font-medium hover:bg-green-700 disabled:opacity-50" disabled={!(name || '').trim()} onClick={handleSave}>
