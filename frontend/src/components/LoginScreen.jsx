...
export function LoginScreen({ time, onLogin }) {
  ...
  return (
    <div className="flex flex-col h-full bg-pos-bg text-pos-text">
      ...
      <div className="mt-5 flex flex-col items-center justify-center gap-8 p-6">
        ...
        <div className="flex items-center gap-10 w-full max-w-3xl">
          ...
          <div ref={rolesScrollRef} className="flex gap-6 overflow-x-auto flex-1 min-w-0 scroll-smooth">
            {loading ? (
              <p className="text-pos-muted text-xl">{t('loginLoadingUsers')}</p>
            ) : (
              users.map((user) => {
                ...
                return (
                  ...
                  >
                    <span className="flex-1 flex items-center justify-center" aria-hidden>
                      <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 256 256" aria-hidden>
                    ...
                    <span className="text-xl font-semibold">{user.label}</span>
                  </button>
                );
              })
            )}
        ...
        <div className="bg-pos-panel rounded-xl shadow-xl p-6 w-full max-w-md mt-10">
